# TODO:
- include a diagram of the directory.
- 
...
To test this out for yourself, visit [Kubetorch Examples]() repository on Github. With minor adjustments, you should be able to deploy the DAG to your own Airflow installation on Kubernetes.
...
- **Reusability** - Compute can be reused for faster iterations and our `inactivity_ttl` setting ensures nothing gets forgotten.
