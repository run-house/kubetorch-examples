...
def load_all_configs(path_prefix: str) -> Dict:
    ...
    try:
        ...
        algos = [
            ...
            if os.path.isfile(os.path.join(dir, f)) and f.endswith(".bpex")
        ]
...
def write_config_into_dedicated_file_for(
    dir_prefix: str, kernel: Any, algo_key: str, configs: Dict
):
    ...
    rel = os.path.relpath(
        get_config_dedicated_file_for(kernel, algo_key), get_bpex_root()
    )
